...
const C = {
  ...
  // Phase 1 section aliases. These intentionally match the existing colors
  // so the app looks the same while giving each area its own control point.
  homeBg: '#6f7f9127',
  homeCard: '#a682b2d9',
  ...
  settingsBg: '#6f7f9127',
  settingsCard: '#a682b2d9',
  settingsCardHigh: '#d7dee6bb',
  profileCard: '#a682b2d9',
  familyCard: '#a682b2d9',
...
const ReminderTimePickerField = ({
  ...
  return (
    <>
      ...
      <Text style={{ color: C.muted, fontSize: 12, marginTop: 6, fontWeight: '600' }}>
        Use AM or PM.
      </Text>
  ...
  return (
    ...
    <SafeAreaView style={[s.screen, { backgroundColor: C.homeBg }]} edges={['top']}>
      ...
      >
        ...
        <Card style={[s.healthScoreCard, { backgroundColor: C.homeCard, borderColor: C.border }]}>
        ...
        <Card style={[s.dashboardTrendCard, { backgroundColor: C.homeCard, borderColor: C.border }]}>
        ...
        <Card style={[s.dashboardAICard, { backgroundColor: C.homeCard, borderColor: C.border }]}>
          <View style={{ flex: 1 }}>
        ...
        <View style={[s.section, { marginTop: 8 }]}>
          ...
          {calendarReminders.length === 0 ? (
            <Card style={[{ backgroundColor: C.homeCard, borderColor: C.border }]}>
        ...
        <View style={[s.section, { marginTop: 8 }]}>
          ...
          {recentActivity.length === 0 ? (
            <Card style={[s.recentActivityEmptyCard, { backgroundColor: C.homeCard, borderColor: C.border }]}>
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
            {pet?.photoUri ? (
              <Image
                source={{ uri: pet.photoUri }}
                style={{ width: 66, height: 66, borderRadius: 18, backgroundColor: C.healthCardHigh }}
              />
            ) : (
              <View
                style={{
                  ...
                  height: 66,
                  borderRadius: 18,
    backgroundColor: C.settingsCardHigh,
                  alignItems: 'center',
                  justifyContent: 'center',
                  borderWidth: 1,
                  borderColor: C.border,
        ...
        {records.length === 0 ? (
          <Card style={{ alignItems: 'center', padding: 32, marginHorizontal: 16, borderRadius: 22, backgroundColor: C.healthCard, borderWidth: 1, borderColor: C.border }}>
            ...
            <View style={{ paddingHorizontal: 18, paddingTop: 18, paddingBottom: 14, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' }}>
              ...
              {selectedRecord?.type === 'imported_file' && selectedRecord.fileUrl ? (
                <View style={{ marginTop: 12, gap: 10 }}>
                  ...
                  <TouchableOpacity
                    style={[s.petProfileButton, { backgroundColor: C.healthCardHigh }]}
            ...
            <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 10 }}>
              ...
              >
                {memoryDraft.photoUri ? (
                  ...
                  <View style={s.memoryPhotoPickerPreview}>
                    <MaterialCommunityIcons name="camera" size={40} color={C.accent} />
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 10 }}>
              {selectedMemory?.photoUri ? (
                isVideoMedia(selectedMemory.mediaType || selectedMemory.mimeType) ? (
                  <View style={{ height: 180, alignItems: 'center', justifyContent: 'center', backgroundColor: C.memoryCard, borderRadius: 16, borderWidth: 1, borderColor: C.border, marginBottom: 12 }}>
                ...
                <View style={{ height: 120, borderRadius: 16, marginBottom: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: C.memoryCard, borderWidth: 1, borderColor: C.border }}>
              ...
              {selectedMemory?.milestoneLabel ? (
                <Text style={{ color: C.text, fontSize: 13, fontWeight: '800', marginBottom: 12 }}>
                  {selectedMemory.milestoneLabel}
                </Text>
              ) : null}
...
function CommunityScreen() {
  ...
  const renderPostCard = (post) => (
    <Card key={post.id} style={{ marginBottom: 14, backgroundColor: C.communityCard }}>
      {post.lost && (
  ...
  const renderRecipeCard = (recipe) => (
    <Card key={recipe.id} style={{ marginBottom: 14, paddingTop: 14, backgroundColor: C.communityCard }}>
      {(() => {
        ...
        {activeCommunityTab === 'lostPets' && (
          <>
            ...
            {visibleLostPetAlerts.length === 0 ? (
              <Card style={{ alignItems: 'center', padding: 24, marginBottom: 14, backgroundColor: C.communityCard }}>
...
function SettingsScreen({ navigation }) {
    ...
    (() => {
      ...
      return (
        ...
        >
          ...
          <View style={s.flex}>
            <Text style={[s.menuLabel, item.accent && { color: C.accent }, item.disabled && { color: C.muted }]}>{item.label}</Text>
  ...
  const menuSections = [
    ...
    },
    {
      title: 'Subscription',
      items: [
        { icon: '⭐', label: 'PetSync+ Premium', sub: 'Coming soon', onPress: () => Alert.alert('PetSync+ Premium', 'PetSync+ Premium coming soon.') },
      ],
    },
    {
      title: 'App Info',
    ...
    <PetSyncBackground opacity={1.08}>
      <SafeAreaView style={s.screen} edges={['top']}>
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
          {/* Profile Card */}
          <Card style={[s.profileCard, { backgroundColor: C.profileCard }]}>
          ...
          <Card style={[s.myPetsCard, { backgroundColor: C.settingsCard }]}>
          ...
          {menuSections.map((section) => (
            ...
            <View key={section.title} style={{ marginBottom: 8 }}>
              {section.title === 'Data & Storage' ? (
                <TouchableOpacity onPress={toggleDataStorageExpanded} activeOpacity={0.88}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16 }}>
                    ...
                    <Text style={[s.menuChevron, { color: C.accent }]}>{showDataStorageExpanded ? '⌃' : '⌄'}</Text>
                  </View>
                </TouchableOpacity>
              ) : section.headerPress ? (
              ...
              {section.title !== 'Data & Storage' || showDataStorageExpanded ? (
                <Card style={{ paddingVertical: 0, backgroundColor: C.settingsCard }}>
        ...
        <Modal visible={showAccountModal} transparent animationType="fade" onRequestClose={() => setShowAccountModal(false)}>
          <View style={s.modalOverlay}>
            <View style={s.customActionModal}>
              ...
              <Text style={{ color: C.muted, marginBottom: 12, textAlign: 'center' }}>
          ...
          <View style={s.modalOverlay}>
            <View style={s.customActionModal}>
              ...
              <View style={{ marginTop: 12, marginBottom: 18 }}>
                <Text style={{ color: C.muted }}>These reminders will continue to show in-app.</Text>
              </View>
        ...
        <Modal visible={showDataStorageModal} transparent animationType="fade" onRequestClose={() => setShowDataStorageModal(false)}>
          <View style={s.modalOverlay}>
            <View style={s.customActionModal}>
              ...
              <Text style={{ color: C.muted, marginBottom: 14 }}>Cloud sync is active through Supabase.</Text>
              {[
                ...
                <View key={label} style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10 }}>
                  ...
                  <Text style={{ color: C.text, fontWeight: '700' }}>{String(value)}</Text>
                </View>
              ))}
              <View style={s.customActionModalButtons}>
          ...
          <View style={s.modalOverlay}>
            <View style={s.customActionModal}>
              ...
              <View style={{ marginBottom: 10 }}>
                <Text style={{ color: C.muted }}>App Name</Text>
                <Text style={{ color: C.text, fontWeight: '700' }}>PetSync+</Text>
              </View>
              <View style={{ marginBottom: 10 }}>
                <Text style={{ color: C.muted }}>Version</Text>
                <Text style={{ color: C.text, fontWeight: '700' }}>v1.0.0</Text>
              </View>
              <View style={{ marginBottom: 10 }}>
                <Text style={{ color: C.muted }}>Supabase</Text>
                <Text style={{ color: C.text, fontWeight: '700' }}>{supabaseConnectedStatus}</Text>
              </View>
              <View style={{ marginBottom: 10 }}>
                <Text style={{ color: C.muted }}>Storage Buckets</Text>
                <Text style={{ color: C.text, fontWeight: '700' }}>{storageBucketsText}</Text>
              </View>
              <View style={{ marginBottom: 18 }}>
                <Text style={{ color: C.muted }}>Current Environment</Text>
                <Text style={{ color: C.text, fontWeight: '700' }}>{appEnvironment}</Text>
              </View>
              <View style={s.customActionModalButtons}>
    ...
    <SafeAreaView style={s.screen} edges={['top', 'bottom']}>
      <View style={s.modalHeader}>
        ...
        <View style={{ alignItems: 'center', flex: 1, paddingHorizontal: 12 }}>
          ...
          <Text style={{ color: C.muted, fontSize: 12, fontWeight: '700', marginTop: 2 }}>General guidance only · Not a real vet</Text>
        </View>
        {messages.length > 0 ? (
          <TouchableOpacity onPress={resetChat} style={{ backgroundColor: C.modalCard, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 }}>
            <Text style={{ color: C.text, fontSize: 12, fontWeight: '800' }}>Clear chat</Text>
          </TouchableOpacity>
        ) : (
          <View style={{ width: 60 }} />
        )}
      ...
      <ScrollView ref={scrollRef} style={s.flex} contentContainerStyle={{ padding: 16, paddingBottom: 18 }} onContentSizeChange={() => scrollRef.current?.scrollToEnd()}>
            ...
            return (
              <TouchableOpacity
                ...
                style={{
                  ...
                  paddingVertical: 8,
                  borderRadius: 999,
                  backgroundColor: isSelected ? `${C.accent}20` : C.modalCard,
                  borderWidth: 1,
              ...
              >
                ...
                <Text style={{ color: isSelected ? C.text : C.muted, fontSize: 12, fontWeight: '900' }}>{pet.label}</Text>
              </TouchableOpacity>
            );
          })}
        </ScrollView>
        ...
        <Card style={{ marginBottom: 12, padding: 14 }}>
          <Text style={{ color: C.text, fontSize: 15, fontWeight: '900' }}>{petContext.name} context</Text>
          <Text style={{ color: C.muted, fontSize: 12, lineHeight: 18, marginTop: 4 }}>{petContextSummary}</Text>
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 }}>
            <View style={{ backgroundColor: C.communityCard, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 }}>
              <Text style={{ color: C.text, fontSize: 12, fontWeight: '800' }}>Weight: {petContext.weight}</Text>
            </View>
            <View style={{ backgroundColor: C.communityCard, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 }}>
              <Text style={{ color: C.text, fontSize: 12, fontWeight: '800' }}>{petContext.medications.length ? `${petContext.medications.length} meds` : 'No active meds'}</Text>
            </View>
            <View style={{ backgroundColor: C.communityCard, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 }}>
              <Text style={{ color: C.text, fontSize: 12, fontWeight: '800' }}>{petContext.vaccinations.length ? `${petContext.vaccinations.length} vaccines` : 'No recent vaccines'}</Text>
            </View>
          </View>
        </Card>
        ...
        {messages.length === 0 ? (
          <>
            <Card style={{ marginBottom: 12, padding: 14, borderLeftWidth: 3, borderLeftColor: C.red, backgroundColor: `${C.red}10` }}>
              <Text style={{ color: C.red, fontSize: 15, fontWeight: '900', marginBottom: 8 }}>Emergency symptoms</Text>
              {[
                'Trouble breathing',
                'Seizures',
                ...
                <Text key={item} style={{ color: C.text, fontSize: 13, lineHeight: 19, marginBottom: 4 }}>• {item}</Text>
              ))}
            ...
            <Card style={{ marginBottom: 12, padding: 14 }}>
              <Text style={{ color: C.text, fontSize: 15, fontWeight: '900', marginBottom: 10 }}>Quick prompts</Text>
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10 }}>
                {[
  ...
  const renderPetPicker = () => (
    <Modal visible={showPetPicker} transparent animationType="fade" onRequestClose={closePetActionPicker}>
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.55)', justifyContent: 'center', padding: 16 }}>
        <View style={{ backgroundColor: C.modalCard, borderRadius: 24, padding: 16, borderWidth: 1, borderColor: C.border, maxHeight: '82%' }}>
          ...
          <TouchableOpacity onPress={closePetActionPicker} style={{ width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', backgroundColor: C.sosCard, borderWidth: 1, borderColor: C.border }}>
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: 6 }}>
            {pets.length === 0 ? (
              <Card style={{ marginTop: 4 }}>
                <Text style={{ color: C.muted, fontSize: 13, lineHeight: 18 }}>Add a pet first to use the SOS tools.</Text>
              </Card>
            ) : pets.map((pet) => (
              <TouchableOpacity
                key={pet.id}
                ...
                style={{
                  ...
                  padding: 12,
                  borderRadius: 18,
                  backgroundColor: pet.id === reportPet?.id ? `${C.accent}12` : C.sosCard,
                  borderWidth: 1,
                  borderColor: pet.id === reportPet?.id ? `${C.accent}50` : C.border,
                  marginBottom: 10,
                }}
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text style={{ color: C.text, fontSize: 15, fontWeight: '900' }}>{pet.name}</Text>
                  <Text style={{ color: C.muted, fontSize: 12, marginTop: 2 }}>{pet.breed || pet.species || 'Pet profile'}</Text>
                </View>
                <Text style={{ color: C.accent, fontSize: 16, fontWeight: '900' }}>›</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
      ...
      <SafeAreaView style={s.screen} edges={['top', 'bottom']}>
        <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingTop: 10, paddingBottom: 160 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={{
            ...
            padding: 14,
            borderWidth: 1,
            backgroundColor: activeReportsCount === 0 ? `${C.green}14` : `${C.red}14`,
            borderColor: activeReportsCount === 0 ? `${C.green}30` : `${C.red}30`,
          }}>
            <Text style={{ color: activeReportsCount === 0 ? C.green : C.red, fontSize: 15, fontWeight: '900' }}>
              {activeReportsCount === 0 ? 'All Pets Safe' : `${activeReportsCount} Pet${activeReportsCount === 1 ? '' : 's'} Reported Lost`}
            </Text>
            <Text style={{ color: C.text, fontSize: 12, lineHeight: 18, marginTop: 6, fontWeight: '600' }}>
          ...
          <Card style={{ marginBottom: 14, padding: 16 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 12 }}>
              <View style={{ flex: 1, paddingRight: 12 }}>
                <Text style={{ color: C.text, fontSize: 16, fontWeight: '900' }}>Quick Actions</Text>
                <Text style={{ color: C.muted, fontSize: 12, marginTop: 4 }}>Fast tools for shelter outreach and sharing.</Text>
              </View>
            </View>
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10 }}>
          ...
          <Card style={{ marginBottom: 14, padding: 16 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
              <View style={{ flex: 1, paddingRight: 12 }}>
                <Text style={{ color: C.text, fontSize: 16, fontWeight: '900' }}>Lost Pet Report</Text>
                <Text style={{ color: C.muted, fontSize: 12, marginTop: 4 }}>Create or update an active lost-pet report.</Text>
              </View>
              <TouchableOpacity
                onPress={() => openPetActionPicker('report')}
                style={{ paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, backgroundColor: `${C.accent}12`, borderWidth: 1, borderColor: `${C.accent}25` }}
                activeOpacity={0.88}
              >
                <Text style={{ color: C.accent, fontSize: 12, fontWeight: '900' }}>{reportPet.name}</Text>
              </TouchableOpacity>
            </View>
            ...
            >
              <View style={{ width: 48, height: 48, borderRadius: 24, backgroundColor: C.sosCard, alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ fontSize: 24 }}>{reportPet.emoji || '🐾'}</Text>
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ color: C.text, fontSize: 15, fontWeight: '900' }}>{reportPet.name}</Text>
                <Text style={{ color: C.muted, fontSize: 12, marginTop: 3 }}>{reportPet.breed || reportPet.species || 'Select a pet to report'}</Text>
              </View>
              <Text style={{ color: C.accent, fontSize: 14, fontWeight: '900' }}>Change</Text>
            </TouchableOpacity>
            ...
            <View style={{
              ...
              <Text style={{ color: C.muted, fontSize: 11, fontWeight: '800', marginBottom: 8 }}>Optional Photo</Text>
            ...
            <Text style={{ color: C.muted, fontSize: 12, fontWeight: '800', marginBottom: 6 }}>Contact Phone *</Text>
            <TextInput
              style={s.textInput}
              value={contactPhone}
            ...
            <Text style={{ color: C.muted, fontSize: 12, fontWeight: '800', marginTop: 12, marginBottom: 6 }}>Last Seen Location</Text>
            <TextInput
              style={s.textInput}
            ...
            <Text style={{ color: C.muted, fontSize: 12, fontWeight: '800', marginTop: 12, marginBottom: 6 }}>Description / Identifying Features</Text>
            <TextInput
            ...
            <Text style={{ color: C.muted, fontSize: 12, fontWeight: '800', marginTop: 12, marginBottom: 6 }}>Reward (optional)</Text>
            <TextInput
              style={s.textInput}
              value={reward}
          ...
          <Card style={{ marginBottom: 14, padding: 16 }}>
            ...
            <Text style={{ color: C.muted, fontSize: 12, marginTop: 4, marginBottom: 12 }}>Live lost reports stay visible here until marked found or deleted.</Text>
            ...
            {activeReports.length === 0 ? (
              <View style={{
                ...
                <Text style={{ color: C.muted, fontSize: 12, lineHeight: 18, marginTop: 4 }}>All pets are currently marked safe.</Text>
              </View>
              ...
              return (
                <View key={alert.id} style={{
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                    <View style={{ width: 52, height: 52, borderRadius: 26, backgroundColor: C.sosCard, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: C.border, overflow: 'hidden' }}>
                      {avatarImage ? (
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={{ color: C.muted, fontSize: 12, marginTop: 3 }}>Lost {formatLostDate(alert.dateReported)}</Text>
                    </View>
                  </View>

                  {alert.lastSeenLocation ? (
                    <Text style={{ color: C.text, fontSize: 13, lineHeight: 19, marginBottom: 6 }}>
                      <Text style={{ color: C.muted, fontWeight: '800' }}>Last seen: </Text>
                      {alert.lastSeenLocation}
                    </Text>
                  ) : null}
                  ...
                  {alert.description ? (
                    <Text style={{ color: C.text, fontSize: 13, lineHeight: 19, marginBottom: 6 }}>
                      <Text style={{ color: C.muted, fontWeight: '800' }}>Features: </Text>
                      {alert.description}
                    </Text>
                  ) : null}
                  ...
                  {reportContactLine ? (
                    <Text style={{ color: C.text, fontSize: 13, lineHeight: 19, marginBottom: 2 }}>
                      <Text style={{ color: C.muted, fontWeight: '800' }}>Help line: </Text>
                      {reportContactLine}
                    </Text>
                  ) : null}
                  ...
                  <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 12 }}>
                    ...
                    <TouchableOpacity style={[s.postAction, { backgroundColor: `${C.red}12`, borderColor: `${C.red}25` }]} onPress={() => removeLostReport(alert)}>
                      <Text style={[s.postActionText, { color: C.red }]}>Delete</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              );
          ...
          <Card style={{ marginBottom: 14, padding: 16 }}>
            <Text style={{ color: C.text, fontSize: 16, fontWeight: '900' }}>Search Tips</Text>
            <Text style={{ color: C.muted, fontSize: 12, marginTop: 4, marginBottom: 10 }}>Focus the search and spread the word quickly.</Text>
            {[
              ...
              <View key={tip} style={{ flexDirection: 'row', gap: 10, alignItems: 'flex-start', marginBottom: 10 }}>
                <Text style={{ color: C.accent, fontSize: 16, fontWeight: '900', lineHeight: 20 }}>•</Text>
                <Text style={{ flex: 1, color: C.text, fontSize: 13, lineHeight: 19, fontWeight: '600' }}>{tip}</Text>
              </View>
            ))}
          </Card>
...
sosButton: {
  ...
  healthAnalyticsCard: {
    backgroundColor: C.healthChartCard,
    borderRadius: 24,
    borderWidth: 1,
    borderColor: '#E6EAF5',
    padding: 16,
  ...
  quickActionAdd:    { borderWidth: 1, borderColor: '#6B4BFF', backgroundColor: C.homeCardHigh },
  modalOverlay:      { flex: 1, backgroundColor: 'rgba(0,0,0,0.58)', justifyContent: 'center', padding: 20 },
  customActionModal: { backgroundColor: C.modalCard, borderRadius: 24, padding: 18, borderWidth: 1, borderColor: C.border },
  customActionModalTitle: { color: C.text, fontSize: 20, fontWeight: '800', marginBottom: 14 },
  customActionInput: { backgroundColor: C.modalCard, color: C.text, borderRadius: 16, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: C.border, marginBottom: 14 },
  iconPickerRow: { paddingVertical: 6, gap: 8 },
  iconPickChip: { width: 64, height: 64, borderRadius: 32, alignItems: 'center', justifyContent: 'center', backgroundColor: C.modalCard, borderWidth: 1, borderColor: C.border, marginRight: 8, padding: 8 },
  ...
  presetActionCard: { width: 110, padding: 12, borderRadius: 18, backgroundColor: C.modalCard, borderWidth: 1, borderColor: C.border, marginRight: 10 },
  ...
  customActionCancelBtn: { flex: 1, paddingVertical: 12, borderRadius: 16, alignItems: 'center', backgroundColor: C.modalCard, borderWidth: 1, borderColor: C.border },
  ...
  reminderModal: { backgroundColor: C.modalCard, borderRadius: 24, padding: 18, borderWidth: 1, borderColor: C.border },
  reminderModalLabel: { color: C.text, fontSize: 13, fontWeight: '800', marginBottom: 8, marginTop: 6 },
  reminderDateCard: { backgroundColor: C.healthCard, borderRadius: 16, borderWidth: 1, borderColor: C.border, paddingHorizontal: 14, paddingVertical: 12, marginBottom: 6 },
  reminderDateCardText: { color: C.text, fontSize: 14, fontWeight: '700' },
  reminderDateCardHint: { color: C.muted, fontSize: 12, marginTop: 3 },

  // Health
  recordIconWrap:    { width: 44, height: 44, borderRadius: 22, backgroundColor: C.healthCardHigh, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  ...
  composeTip:        { backgroundColor: C.communityCard, borderRadius: 16, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: C.border },
    communityTabRow:   { gap: 10, paddingBottom: 14 },
  communityTabPill:  { backgroundColor: C.communityCard, borderRadius: 999, paddingHorizontal: 15, paddingVertical: 10, borderWidth: 1, borderColor: C.border },
    ...
    recipeEmojiWrap:   { width: 56, height: 56, borderRadius: 18, backgroundColor: C.communityCard, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: C.border },
    ...
    recipePill:        { flexGrow: 1, flexBasis: '48%', backgroundColor: C.communityCardHigh, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: C.border },
    ...
    recipeIngredientsBlock: { backgroundColor: C.communityCard, borderRadius: 14, padding: 12, borderWidth: 1, borderColor: C.border, marginBottom: 12 },
    ...
    recipeExpandToggle: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: C.communityCardHigh, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 11, borderWidth: 1, borderColor: C.border, marginBottom: 12 },
    ...
    recipeInstructionsBlock: { backgroundColor: C.communityCard, borderRadius: 14, padding: 12, borderWidth: 1, borderColor: C.border, marginBottom: 12 },
    ...
    recipeInstructionNumber: { width: 24, height: 24, borderRadius: 12, backgroundColor: C.communityCardHigh, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: C.border, marginTop: 1 },
    ...
    recipeOwnerBtn:    { flex: 1, backgroundColor: C.communityCardHigh, borderRadius: 14, paddingVertical: 11, alignItems: 'center', borderWidth: 1, borderColor: C.border },
  ...
  recipeInput:       { backgroundColor: C.communityCard, color: C.text, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: C.border },
    recipeTextArea:    { minHeight: 92, textAlignVertical: 'top' },
    recipeModalTip:    { marginTop: 16, backgroundColor: C.communityCardHigh, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: C.border },
    recipeModalTipText: { color: C.muted, fontSize: 12, lineHeight: 18, fontWeight: '600' },

    // Health Hub local vet finder
  localVetFinderToggle: { marginTop: 12, marginHorizontal: 16, backgroundColor: C.aiVetCard, borderRadius: 18, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: C.border, flexDirection: 'row', alignItems: 'center', gap: 12 },
    ...
    localVetFinderModalHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, paddingHorizontal: 16, paddingTop: 54, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: C.border, backgroundColor: C.aiVetCard },
  ...
  localVetFinderCloseBtn: { width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: C.aiVetCard, borderWidth: 1, borderColor: C.border, marginTop: 2 },
    ...
    localVetFinderCard: { padding: 16, marginBottom: 14, borderRadius: 24, backgroundColor: C.aiVetCard, borderWidth: 1, borderColor: 'rgba(255, 153, 0, 0.12)' },
  ...
  localVetFinderSecondaryBtn: { backgroundColor: C.aiVetCard, borderWidth: 1, borderColor: C.border },
  ...
  localVetEmptyState: { backgroundColor: C.aiVetCard, borderRadius: 16, padding: 14, borderWidth: 1, borderColor: C.border, marginBottom: 12 },
    localVetEmptyStateText: { color: C.muted, fontSize: 12, lineHeight: 18, fontWeight: '600' },
  localVetCard: { backgroundColor: C.aiVetCard, borderRadius: 18, padding: 14, borderWidth: 1, borderColor: C.border, marginBottom: 12 },
    localVetCardTopRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  localVetAvatar: { width: 40, height: 40, borderRadius: 20, backgroundColor: C.aiVetCard, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: C.border },
  ...
  localVetStatusPill: { backgroundColor: C.aiVetCard, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 5, borderWidth: 1, borderColor: C.border },
  ...
  localVetMetaItem: { flexBasis: '48%', backgroundColor: C.aiVetCard, borderRadius: 14, padding: 10, borderWidth: 1, borderColor: C.border },
  ...
  localVetActionBtn: { flexGrow: 1, flexBasis: '31%', backgroundColor: C.aiVetCard, borderRadius: 14, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: C.border },
  ...
  profileAvatarCircle: { width: 56, height: 56, borderRadius: 28, backgroundColor: C.settingsCard, alignItems: 'center', justifyContent: 'center' },
  ...
  profileAvatarInitials: { color: C.text, fontSize: 18, fontWeight: '900' },
  ...
  profileAvatarPicker: { width: 96, height: 96, borderRadius: 48, backgroundColor: C.profileCard, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: C.border },
  profileAvatarPickerImage: { width: '100%', height: '100%' },
  profileAvatarPickerInitials: { color: C.text, fontSize: 28, fontWeight: '900' },
  profileAvatarPickerHint: { color: C.muted, fontSize: 12, fontWeight: '600', textAlign: 'center', marginTop: 8, marginBottom: 12 },
  myPetsCard:        { marginHorizontal: 16, marginTop: 2, marginBottom: 10, padding: 16, borderRadius: 22 },
  myPetsHeaderRow:   { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12, marginBottom: 12 },
  myPetsTitle:       { color: C.text, fontSize: 18, fontWeight: '900' },
  myPetsSub:         { color: C.muted, fontSize: 12, lineHeight: 17, marginTop: 3, fontWeight: '600' },
  myPetsAddBtn:      { backgroundColor: C.accent, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8, alignItems: 'center', justifyContent: 'center' },
  myPetsAddBtnText:  { color: '#fff', fontSize: 12, fontWeight: '900' },
  myPetsSearchWrap:  { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: C.settingsCard, borderRadius: 16, borderWidth: 1, borderColor: C.border, paddingHorizontal: 12, paddingVertical: 10 },
  myPetsSearchIcon:  { color: C.muted, fontSize: 16, fontWeight: '900' },
  myPetsSearchInput: { flex: 1, color: C.text, fontSize: 14, fontWeight: '700', paddingVertical: 0 },
  ...
  myPetsSearchClearText: { color: C.text, fontSize: 13, fontWeight: '900' },
  myPetsEmptyState:  { backgroundColor: C.settingsCard, borderRadius: 18, padding: 14, borderWidth: 1, borderColor: C.border, alignItems: 'center' },
  myPetsEmptyTitle:  { color: C.text, fontSize: 15, fontWeight: '900', textAlign: 'center' },
  myPetsEmptyBody:   { color: C.muted, fontSize: 12, lineHeight: 18, marginTop: 4, textAlign: 'center' },
  myPetsEmptyBtn:    { marginTop: 12, backgroundColor: C.accent, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 10 },
  myPetsEmptyBtnText: { color: '#fff', fontSize: 12, fontWeight: '900' },
  myPetsCardItem:    { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, borderRadius: 18, backgroundColor: C.settingsCard, borderWidth: 1, borderColor: C.border, marginBottom: 10 },
  myPetsAvatarWrap:  { width: 56, height: 56, borderRadius: 18, backgroundColor: C.profileCard, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: C.border },
  ...
  myPetsCardName:    { color: C.text, fontSize: 16, fontWeight: '900' },
  myPetsCardBreed:   { color: C.muted, fontSize: 12, fontWeight: '700', marginTop: 3 },
  myPetsLostBadge:   { backgroundColor: `${C.red}18`, borderWidth: 1, borderColor: `${C.red}35`, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4 },
  myPetsLostBadgeText: { color: C.red, fontSize: 10, fontWeight: '900', letterSpacing: 0.7 },
  myPetsSharedBadge: { backgroundColor: `${C.accent}18`, borderWidth: 1, borderColor: `${C.accent}35`, borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4 },
  myPetsSharedBadgeText: { color: C.accent, fontSize: 10, fontWeight: '900', letterSpacing: 0.7 },
  myPetsMetaWrap:    { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 10 },
  myPetsMetaPill:    { backgroundColor: C.settingsCardHigh, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 },
  myPetsMetaText:    { color: C.text, fontSize: 11, fontWeight: '800' },
  myPetsCardActions: { alignItems: 'center', justifyContent: 'space-between', alignSelf: 'stretch', paddingLeft: 2 },
  myPetsDeleteBtn:   { width: 34, height: 34, borderRadius: 17, backgroundColor: `${C.red}12`, borderWidth: 1, borderColor: `${C.red}25`, alignItems: 'center', justifyContent: 'center' },
  ...
  signOutBtn:        { marginHorizontal: 16, marginTop: 18, backgroundColor: C.settingsCard, borderRadius: 14, paddingVertical: 15, alignItems: 'center', borderWidth: 1, borderColor: C.red + '70' },
  ...
  petContextBar:     { marginHorizontal: 12, marginBottom: 4, backgroundColor: C.modalCard, borderRadius: 12, padding: 10, borderWidth: 1, borderColor: C.border },
  ...
  chatBubbleAIBg:    { backgroundColor: C.modalCard, borderBottomLeftRadius: 5, borderWidth: 1, borderColor: C.border },
  ...
  suggestion:        { backgroundColor: C.modalCard, borderRadius: 18, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: C.border },
  suggestionText:    { color: C.muted, fontSize: 12, fontWeight: '700' },
  aiVetResourcesCard: { marginTop: 8, backgroundColor: C.modalCard, borderRadius: 18, padding: 12, borderWidth: 1, borderColor: C.border },
  aiVetResourcesTitle:{ color: C.text, fontSize: 13, fontWeight: '900', marginBottom: 8 },
    aiVetResourceLink:  { paddingVertical: 8, paddingHorizontal: 10, borderRadius: 14, backgroundColor: C.modalCard, borderWidth: 1, borderColor: C.border, marginBottom: 8 },
  ...
  chatInput:         { flex: 1, minHeight: 46, maxHeight: 110, backgroundColor: C.modalCard, borderRadius: 18, color: C.text, paddingHorizontal: 14, paddingVertical: 11, fontSize: 15 },
  ...
  petProfileAvatarCircle: { width: 120, height: 120, borderRadius: 60, backgroundColor: C.profileCard, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: C.border },
  ...
  petProfileChip:       { backgroundColor: C.profileCard, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7, borderWidth: 1, borderColor: C.border },
  ...
  petProfileActivityIcon:  { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: C.profileCard, borderWidth: 1, borderColor: C.border },
  ...
  petProfileButton:      { backgroundColor: C.profileCard, borderRadius: 16, paddingVertical: 14, paddingHorizontal: 14, alignItems: 'center', borderWidth: 1, borderColor: C.border },
  ...
  communityProfileInfoCard: { marginHorizontal: 16, marginTop: 12, padding: 16, borderRadius: 20, backgroundColor: C.communityCard },
  ...
  // Family Sharing
  familySharingOwnerCard: { marginHorizontal: 16, marginTop: 4, padding: 16, borderRadius: 20, alignItems: 'center', backgroundColor: C.familyCard },
  ...
  familySharingEmptyCard: { padding: 18, borderRadius: 18, marginBottom: 14, alignItems: 'center', backgroundColor: C.familyCard },
  ...
  communityCommentsCard: { padding: 16, borderRadius: 20, marginBottom: 12, backgroundColor: C.communityCard },
  ...
  petSelectCard:     { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: C.sosCard, borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: C.border },
  petSelectCardActive: { borderColor: C.red, backgroundColor: C.sosCard },
  ...
  textAreaInput:     { backgroundColor: C.sosCard, color: C.text, borderRadius: 14, padding: 13, minHeight: 98, textAlignVertical: 'top', marginBottom: 16, borderWidth: 1, borderColor: C.border },
  radiusBtn:         { flex: 1, backgroundColor: C.sosCard, borderRadius: 14, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: C.border },
  ...
  shareBtn:          { flex: 1, backgroundColor: C.sosCard, borderRadius: 14, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: C.border },
