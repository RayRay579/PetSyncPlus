          ...
          <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ width: '100%' }}>
            ...
            >
              ...
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 12 }}>
                ...
                <TextInput
                  style={s.addPetInput}
                  value={editPetDraft.birthMode === 'birthday' ? editPetDraft.birthday : editPetDraft.ageText}
                  onChangeText={(text) => {
                    setEditPetDraft((prev) => (
                      prev.birthMode === 'birthday'
                        ? { ...prev, birthday: text }
                        : { ...prev, ageText: text }
                    ));
                  }}
                  placeholder={editPetDraft.birthMode === 'birthday' ? 'YYYY-MM-DD' : 'Age, e.g. 3 yrs'}
                  placeholderTextColor={C.muted}
                  autoCapitalize="none"
                />
