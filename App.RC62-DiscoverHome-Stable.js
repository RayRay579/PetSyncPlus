          ...
          >
            <View style={s.discoverPage}>
              ...
              <DiscoverSection
                ...
                renderItem={(category) => (
                  <View key={category.id} style={[s.discoverCategoryCard, { width: categoryCardWidth }]}>
              ...
              <DiscoverSection
                ...
                renderItem={(business) => (
                  <View key={business.id} style={[s.discoverBusinessCard, { width: businessCardWidth }]}>
              ...
              <DiscoverSection
                ...
                renderItem={(pet) => {
                  ...
                  return (
                    <View key={pet.id} style={[s.discoverPetCard, { width: petCardWidth }]}>
              ...
              <DiscoverSection
                ...
                renderItem={(event) => (
                  <View key={event.id} style={[s.discoverEventCard, { width: eventCardWidth }]}>
                    {event.image_url ? (
              ...
              <DiscoverSection
                ...
                renderItem={(promotion) => (
                  <View key={promotion.id} style={[s.discoverPromoCard, { width: promoCardWidth }]}>
                    {promotion.image_url ? (
