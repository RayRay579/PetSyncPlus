...
function FeatureLockedModal({ visible, feature, onClose }) {
  ...
  const featureMessage = feature.message || 'This feature is part of Premium.';
        ...
        <View style={[s.customActionModal, s.featureLockedModal]}>
          ...
          >
            <View style={s.featureLockedBadge}>
              <Text style={s.featureLockedBadgeText}>Premium coming soon</Text>
            </View>
            ...
            <Text style={s.featureLockedFooter}>
              You can keep using the free version while Premium is in progress.
            </Text>
          </ScrollView>
  ...
  const handleAIVetPress = () => {
    if (authReady && !isPremiumUser(authProfile)) {
      openLockedFeature(
        'ai_vet_assistant',
        'AI Vet',
        'AI Vet is a Premium feature. Premium coming soon.'
      );
      return;
    }
    navigation.navigate('AIVet', { selectedPetId: pet.id });
  ...
  const openAddRecordPrompt = () => {
    if (authReady && !canManageHealthRecords) {
      openLockedFeature(
        'health_records',
        'Add Health Record',
        'Health records are a Premium feature. Premium coming soon.'
      );
      return;
    }
  ...
  const openExportPreview = async () => {
    if (authReady && !isPremiumUser(authProfile)) {
      openLockedFeature(
        ...
        'Health exports are a Premium feature. Premium coming soon.'
      );
      return;
    }
  ...
  const openPostModal = (post = null) => {
    if (authReady && !canPublishCommunity) {
      openLockedFeature(
        'community_posting',
        'New Post',
        'Community posting is a Premium feature. Premium coming soon.'
      );
      return;
    }
  ...
  const openRecipeModal = (recipe = null) => {
    if (authReady && !canPublishCommunity) {
      openLockedFeature(
        'community_recipes',
        'New Recipe',
        'Community recipes are a Premium feature. Premium coming soon.'
      );
      return;
    }
  ...
  useEffect(() => {
    ...
    if (authReady && !isPremiumUser(authProfile)) {
      ...
      openLockedFeature(
        'family_sharing',
        'Family Sharing',
        'Family Sharing is a Premium feature. Premium coming soon.',
        () => navigation.goBack()
      );
    }
...
function SettingsScreen({ navigation, route }) {
  ...
  const revenueCatStatusLabel = revenueCatReady ? 'Subscription system ready' : 'Subscription loading';
  const revenueCatEntitlementLabel = premiumSubscriptionActive ? 'Active' : 'Inactive';
              ...
              <View style={[s.customActionModal, s.subscriptionModal]}>
                ...
                >
                  ...
                  <View style={s.subscriptionPlanCard}>
                    ...
                    <Text style={s.subscriptionPlanNote}>
                      {premiumSubscriptionActive
                        ? 'Premium features are active on this account.'
                        : 'Free users can upgrade at any time to unlock Premium.'}
                    </Text>
                  </View>
                  ...
                  <View style={s.subscriptionPlanCard}>
                    ...
                    <Text style={s.subscriptionPlanNote}>Premium entitlement: {revenueCatEntitlementLabel}</Text>
                  </View>
  ...
  useEffect(() => {
    ...
    if (authReady && !isPremiumUser(authProfile)) {
      ...
      openLockedFeature(
        'lost_pet_sos',
        'Lost Pet SOS',
        'Lost Pet SOS is a Premium feature. Premium coming soon.',
        () => navigation.goBack()
      );
    }
  }, [authProfile, authReady, navigation, openLockedFeature]);
