          ...
          >
            <View style={s.discoverPage}>
              ...
              <DiscoverSection
                ...
                subtitle="Your bookmarked businesses, pets, and events."
                items={filteredFavoriteItems}
                loading={discoverFavoritesLoading}
                emptyTitle="No saved Discover items yet."
                emptyText="Tap the heart on a business, adoptable pet, or event to save it here."
                    ...
                    >
                      <View style={s.discoverFavoriteCardHeader}>
                        ...
                        <DiscoverFavoriteButton
                          active
                          compact
                          onPress={() => toggleDiscoverFavorite(favorite.favorite_type, item)}
                        />
                      </View>
                  ...
                  >
                    <View style={s.discoverBusinessTopRow}>
                      ...
                      <DiscoverFavoriteButton
                        ...
                        onPress={() => toggleDiscoverFavorite('business', business)}
                      />
                    </View>
                  ...
                  >
                    <View style={s.discoverBusinessTopRow}>
                      ...
                      <DiscoverFavoriteButton
                        ...
                        onPress={() => toggleDiscoverFavorite('shelter', shelter)}
                      />
                    </View>
                      ...
                      <View style={s.discoverPetBody}>
                        <View style={s.discoverCardTitleRow}>
                          ...
                          <DiscoverFavoriteButton
                            ...
                            onPress={() => toggleDiscoverFavorite('adoptable_pet', pet)}
                          />
                        </View>
                        <View style={s.discoverChipRow}>
                          {pet.age_label ? (
                    ...
                    <View style={s.discoverEventBody}>
                      <View style={s.discoverCardTitleRow}>
                        ...
                        <DiscoverFavoriteButton
                          ...
                          onPress={() => toggleDiscoverFavorite('pet_event', event)}
                        />
                      </View>
                      <View style={s.discoverChipRow}>
                      ...
                      <Text numberOfLines={1} style={s.discoverCardFootnote}>
                        {[formatDiscoverDateTime(event.starts_at), [event.city, event.state].filter(Boolean).join(', ')].filter(Boolean).join(' • ') || 'Date and location coming soon'}
                      </Text>
                    </View>
                  </TouchableOpacity>
                )}
                    ...
                    <View style={s.discoverDetailModalShell}>
                      ...
                      >
                        {selectedDetailType === 'category' && selectedDetailCategory ? (
                          <>
                            <DiscoverDetailSection title="Category">
                              ...
                              <View style={s.discoverDetailHeroBody}>
                                <View style={s.discoverDetailHeroTitleRow}>
                                  ...
                                  <DiscoverFavoriteButton
                                    ...
                                    onPress={() => toggleDiscoverFavorite('shelter', selectedDetailShelter)}
                                  />
                                </View>
                                <View style={s.discoverChipRow}>
                          ...
                          <>
                              ...
                              <View style={s.discoverDetailHeroBody}>
                                <View style={s.discoverDetailHeroTitleRow}>
                                  ...
                                  <DiscoverFavoriteButton
                                    ...
                                    onPress={() => toggleDiscoverFavorite('business', selectedDetailBusiness)}
                                  />
                                </View>
                                <View style={s.discoverChipRow}>
                            ...
                            <DiscoverDetailSection title="Hours">
                              <Text style={s.discoverDetailLine}>
                                {selectedDetailBusiness.hours_json && Object.keys(selectedDetailBusiness.hours_json || {}).length > 0
                                  ? JSON.stringify(selectedDetailBusiness.hours_json)
                            ...
                            <DiscoverDetailSection title="Promotions">
                              {filteredPromotions.filter((promotion) => promotion.business_id === selectedDetailBusiness.id).length > 0 ? (
                                ...
                                <Text style={s.discoverDetailEmptyText}>No active promotions for this business.</Text>
                              )}
                            </DiscoverDetailSection>

                            <DiscoverDetailSection title="Reviews">
                              <Text style={s.discoverDetailEmptyText}>Reviews are coming soon.</Text>
                            </DiscoverDetailSection>
                          </>
                            ...
                            <View style={s.discoverDetailMediaStrip}>
                              {Array.isArray(selectedDetailPet.media) && selectedDetailPet.media.length > 0 ? (
                                ...
                                <View style={s.discoverDetailMediaEmpty}>
                                  ...
                                  <Text style={s.discoverDetailEmptyText}>No media available yet.</Text>
                                </View>
                              )}
                            </View>
                            ...
                            <DiscoverDetailSection title="About">
                              <View style={s.discoverDetailHeroTitleRow}>
                                ...
                                <DiscoverFavoriteButton
                                  ...
                                  onPress={() => toggleDiscoverFavorite('adoptable_pet', selectedDetailPet)}
                                />
                              </View>
                              <View style={s.discoverChipRow}>
                          ...
                          <>
                            <DiscoverDetailSection title="Event">
                              <View style={s.discoverDetailHeroTitleRow}>
                                ...
                                <DiscoverFavoriteButton
                                  ...
                                  onPress={() => toggleDiscoverFavorite('pet_event', selectedDetailEvent)}
                                />
                              </View>
                            ...
                            <DiscoverDetailSection title="Registration">
                              {selectedDetailEvent.registration_url ? (
                                ...
                                <Text style={s.discoverDetailEmptyText}>No registration link provided.</Text>
                              )}
                            </DiscoverDetailSection>
                          </>
