                  ...
                  >
                    <View
                      style={{
                        ...
                        borderRadius: 6,
                        borderWidth: 1,
                        borderColor: addReminderToCalendar ? C.accent : C.inputBorder,
            ...
            return (
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderWidth: 1,
                  borderColor: isSelected ? C.accent : C.aiVetCardBorder,
                }}
            ...
            {pets.length === 0 ? (
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderWidth: 1,
                  borderColor: pet.id === reportPet?.id ? `${C.accent}50` : C.sosCardBorder,
                  marginBottom: 10,
                }}
              >
