  ...
  return (
    ...
    <SafeAreaView style={[s.screen, { backgroundColor: C.homeBg }]} edges={['top']}>
      ...
      >
        ...
        <Card style={[s.healthScoreCard, { backgroundColor: C.healthScoreCard, borderColor: C.border }]}>
        ...
        <Card style={[s.dashboardTrendCard, { backgroundColor: C.homeRecentActivityCard, borderColor: C.border }]}>
        ...
        <Card style={[s.dashboardAICard, { backgroundColor: C.aiVetCard, borderColor: C.border }]}>
          <View style={{ flex: 1 }}>
        ...
        <Card style={[{ backgroundColor: C.homeRecentActivityCard, borderColor: C.border }]}>
        ...
        <View style={[s.section, { marginTop: 8 }]}>
          ...
          {recentActivity.length === 0 ? (
            <Card style={[s.recentActivityEmptyCard, { backgroundColor: C.homeRecentActivityCard, borderColor: C.border }]}>
            ...
            recentActivity.map(log => (
              ...
              >
                <Card style={[s.recentActivityCard, { backgroundColor: C.homeRecentActivityCard, borderColor: C.border }]}>
  ...
  return (
    ...
    <SafeAreaView style={s.screen} edges={['top']}>
      ...
      >
        ...
        {records.length === 0 ? (
          <Card style={{ alignItems: 'center', padding: 32, marginHorizontal: 16, borderRadius: 22, backgroundColor: C.healthRecordCard, borderWidth: 1, borderColor: C.border }}>
...
sosButton: {
  ...
  tabPill:           { backgroundColor: C.surfacePill, borderRadius: 20, paddingHorizontal: 13, paddingVertical: 8, borderWidth: 1, borderColor: C.border },
  ...
  quickActionAdd:    { borderWidth: 1, borderColor: '#6B4BFF', backgroundColor: C.homeQuickActionCard },
  modalOverlay:      { flex: 1, backgroundColor: 'rgba(0,0,0,0.58)', justifyContent: 'center', padding: 20 },
  customActionModal: { backgroundColor: C.modalContainer, borderRadius: 24, padding: 18, borderWidth: 1, borderColor: C.border },
  customActionModalTitle: { color: C.text, fontSize: 20, fontWeight: '800', marginBottom: 14 },
  customActionInput: { backgroundColor: C.modalInput, color: C.text, borderRadius: 16, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: C.border, marginBottom: 14 },
  iconPickerRow: { paddingVertical: 6, gap: 8 },
  iconPickChip: { width: 64, height: 64, borderRadius: 32, alignItems: 'center', justifyContent: 'center', backgroundColor: C.modalOptionPill, borderWidth: 1, borderColor: C.border, marginRight: 8, padding: 8 },
  iconPickChipActive: { borderColor: C.accent, borderWidth: 2, backgroundColor: C.modalOptionPillActive },
  ...
  presetActionCard: { width: 110, padding: 12, borderRadius: 18, backgroundColor: C.modalOptionPill, borderWidth: 1, borderColor: C.border, marginRight: 10 },
  ...
  customActionCancelBtn: { flex: 1, paddingVertical: 12, borderRadius: 16, alignItems: 'center', backgroundColor: C.modalSecondaryButton, borderWidth: 1, borderColor: C.border },
  ...
  composeTip:        { backgroundColor: C.communityBadge, borderRadius: 16, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: C.border },
    communityTabRow:   { gap: 10, paddingBottom: 14 },
  communityTabPill:  { backgroundColor: C.communityTabPill, borderRadius: 999, paddingHorizontal: 15, paddingVertical: 10, borderWidth: 1, borderColor: C.border },
  ...
  recipePill:        { flexGrow: 1, flexBasis: '48%', backgroundColor: C.communityCardHigh, borderRadius: 14, paddingHorizontal: 12, paddingVertical: 10, borderWidth: 1, borderColor: C.border },
    ...
    recipeIngredientsBlock: { backgroundColor: C.communityRecipeCard, borderRadius: 14, padding: 12, borderWidth: 1, borderColor: C.border, marginBottom: 12 },
  ...
  profileAvatarPicker: { width: 96, height: 96, borderRadius: 48, backgroundColor: C.profileAvatarSurface, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: C.border },
  ...
  myPetsSearchWrap:  { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: C.settingsSearchInput, borderRadius: 16, borderWidth: 1, borderColor: C.border, paddingHorizontal: 12, paddingVertical: 10 },
  ...
  myPetsEmptyState:  { backgroundColor: C.settingsPetCard, borderRadius: 18, padding: 14, borderWidth: 1, borderColor: C.border, alignItems: 'center' },
  ...
  myPetsCardItem:    { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, borderRadius: 18, backgroundColor: C.settingsPetCard, borderWidth: 1, borderColor: C.border, marginBottom: 10 },
  myPetsAvatarWrap:  { width: 56, height: 56, borderRadius: 18, backgroundColor: C.profileAvatarSurface, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: C.border },
  ...
  signOutBtn:        { marginHorizontal: 16, marginTop: 18, backgroundColor: C.settingsDangerCard, borderRadius: 14, paddingVertical: 15, alignItems: 'center', borderWidth: 1, borderColor: C.red + '70' },
  ...
  communityCommentsCard: { padding: 16, borderRadius: 20, marginBottom: 12, backgroundColor: C.communityCommentCard },
  ...
  petSelectCardActive: { borderColor: C.red, backgroundColor: C.sosActionCard },
  ...
  textAreaInput:     { backgroundColor: C.sosEmergencyCard, color: C.text, borderRadius: 14, padding: 13, minHeight: 98, textAlignVertical: 'top', marginBottom: 16, borderWidth: 1, borderColor: C.border },
  radiusBtn:         { flex: 1, backgroundColor: C.sosActionCard, borderRadius: 14, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: C.border },
  ...
  shareBtn:          { flex: 1, backgroundColor: C.sosActionCard, borderRadius: 14, paddingVertical: 12, alignItems: 'center', borderWidth: 1, borderColor: C.border },
