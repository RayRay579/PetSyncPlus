      ...
      <View style={s.modalOverlay}>
        <View style={s.customActionModal}>
          ...
          <View style={{
            ...
            <Text style={{ color: C.aiVetAccent, fontSize: 11, fontWeight: '900', letterSpacing: 0.6 }}>
              Premium coming soon
            </Text>
          </View>
          <Text style={{
            color: C.modalBodyText,
            fontSize: 13,
            lineHeight: 20,
            fontWeight: '600',
          }}>
          ...
          <Text style={{
            color: C.modalMutedText,
            fontSize: 12,
            lineHeight: 18,
            marginTop: 10,
            fontWeight: '600',
          }}>
            Premium unlocks the full version of this feature.
          </Text>
