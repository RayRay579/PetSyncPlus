...
const FEATURE_LOCKED_BENEFITS = {
  ...
  default: [
    ...
    'Keep your current free experience while Premium is coming soon',
  ],
};
...
function SettingsScreen({ navigation, route }) {
  ...
  const revenueCatStatusLabel = revenueCatReady ? 'Subscription ready' : 'Checking subscription status...';
            ...
            <View style={s.modalOverlay}>
              <View style={[s.customActionModal, s.subscriptionModal]}>
                ...
                >
                  ...
                  <Text style={s.subscriptionBenefitsTitle}>Premium benefits</Text>
...
sosButton: {
  ...
  subscriptionPlanLabel: { color: C.settingsMutedText, fontSize: 11, fontWeight: '900', textTransform: 'uppercase', letterSpacing: 0.8 },
  subscriptionPlanValue: { color: C.settingsTitleText, fontSize: 15, fontWeight: '900', marginTop: 4 },
  subscriptionPlanNote: { color: C.settingsBodyText, fontSize: 12, fontWeight: '600', lineHeight: 18, marginTop: 6 },
  subscriptionBenefitsTitle: { color: C.modalTitleText, fontSize: 15, fontWeight: '900', marginBottom: 10 },
  subscriptionBenefitsList: { gap: 8, marginBottom: 8 },
