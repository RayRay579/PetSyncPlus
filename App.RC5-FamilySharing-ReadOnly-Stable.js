      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.petProfileScroll}>
        ...
        <Card style={s.petProfileHeroCard}>
          <View style={s.petProfileAvatarWrap}>
            ...
            {pet?.isShared ? (
              <Text style={s.petProfileSubtitle}>Family Shared pet: view-only access</Text>
            ) : null}
  ...
  return (
    ...
    <SafeAreaView style={s.screen} edges={['top']}>
      ...
      >
        ...
        {records.length === 0 ? (
          <Card style={{ alignItems: 'center', padding: 32, marginHorizontal: 16, borderRadius: 22, backgroundColor: '#70618f85', borderWidth: 1, borderColor: C.border }}>
          ...
          <View style={[s.customActionModal, { width: '100%', maxHeight: '88%' }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={{ paddingBottom: 10 }}>
              ...
              <View style={s.familySharingNote}>
                <Text style={s.familySharingNoteText}>Family members must currently be added manually. Email invites are coming soon.</Text>
              </View>
  ...
  return (
    <SafeAreaView style={s.screen} edges={['top', 'bottom']}>
      <View style={s.modalHeader}>
        ...
        {messages.length > 0 ? (
          <TouchableOpacity onPress={resetChat} style={{ backgroundColor: C.card, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 }}>
      ...
      <ScrollView ref={scrollRef} style={s.flex} contentContainerStyle={{ padding: 16, paddingBottom: 18 }} onContentSizeChange={() => scrollRef.current?.scrollToEnd()}>
            ...
            return (
              <TouchableOpacity
                ...
                style={{
                  ...
                  paddingVertical: 8,
                  borderRadius: 999,
                  backgroundColor: isSelected ? `${C.accent}20` : C.card,
                  borderWidth: 1,
        ...
        <Card style={{ marginBottom: 12, padding: 14 }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 }}>
            <View style={{ backgroundColor: C.bg, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 }}>
  ...
  const renderPetPicker = () => (
    <Modal visible={showPetPicker} transparent animationType="fade" onRequestClose={closePetActionPicker}>
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.55)', justifyContent: 'center', padding: 16 }}>
        <View style={{ backgroundColor: C.card, borderRadius: 24, padding: 16, borderWidth: 1, borderColor: C.border, maxHeight: '82%' }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            ...
            <TouchableOpacity onPress={closePetActionPicker} style={{ width: 34, height: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', backgroundColor: C.bg, borderWidth: 1, borderColor: C.border }}>
            ...
            {pets.length === 0 ? (
              ...
              <TouchableOpacity
                ...
                style={{
                  ...
                  padding: 12,
                  borderRadius: 18,
                  backgroundColor: pet.id === reportPet?.id ? `${C.accent}12` : C.bg,
                  borderWidth: 1,
                  borderColor: pet.id === reportPet?.id ? `${C.accent}50` : C.border,
                  marginBottom: 10,
                }}
              >
                <View style={{ width: 46, height: 46, borderRadius: 23, backgroundColor: C.cardHigh, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
      ...
      <SafeAreaView style={s.screen} edges={['top', 'bottom']}>
        <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingTop: 10, paddingBottom: 160 }} showsVerticalScrollIndicator={false}>
          ...
          <Card style={{ marginBottom: 14, padding: 16 }}>
            ...
            >
              <View style={{ width: 48, height: 48, borderRadius: 24, backgroundColor: C.cardHigh, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <View style={{
              ...
              <View style={{ width: 84, height: 84, borderRadius: 42, backgroundColor: C.cardHigh, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', marginBottom: 10 }}>
                {photoUri ? (
              ...
              return (
                <View key={alert.id} style={{
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                    <View style={{ width: 52, height: 52, borderRadius: 26, backgroundColor: C.bg, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: C.border, overflow: 'hidden' }}>
                      {avatarImage ? (
...
sosButton: {
  ...
  padding: 15,
  borderWidth: 1,
  backgroundColor: 'rgba(255, 248, 248, 0.46)',
  borderColor: 'rgba(126,87,194,0.14)',
  shadowColor: '#7B61FF',
  ...
  profileAvatarPicker: { width: 96, height: 96, borderRadius: 48, backgroundColor: C.bg, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: C.border },
  ...
  myPetsSearchWrap:  { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: C.bg, borderRadius: 16, borderWidth: 1, borderColor: C.border, paddingHorizontal: 12, paddingVertical: 10 },
  ...
  myPetsSearchClearBtn: { width: 28, height: 28, borderRadius: 14, backgroundColor: C.cardHigh, alignItems: 'center', justifyContent: 'center' },
  myPetsSearchClearText: { color: C.text, fontSize: 13, fontWeight: '900' },
  myPetsEmptyState:  { backgroundColor: C.bg, borderRadius: 18, padding: 14, borderWidth: 1, borderColor: C.border, alignItems: 'center' },
  ...
  myPetsCardItem:    { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, borderRadius: 18, backgroundColor: C.bg, borderWidth: 1, borderColor: C.border, marginBottom: 10 },
  myPetsAvatarWrap:  { width: 56, height: 56, borderRadius: 18, backgroundColor: C.cardHigh, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: C.border },
  ...
  myPetsMetaPill:    { backgroundColor: C.cardHigh, borderWidth: 1, borderColor: C.border, borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 },
