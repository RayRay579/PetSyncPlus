...
const ADMIN_EMAILS = ['rayray579@gmail.com'];
...
function DiscoverHomeScreen() {
  ...
  const openDiscoverRegistration = () => {
    if (!authUser?.id) {
      Alert.alert('Sign in required', 'Sign in to submit a listing.');
      return;
    }
    setFavoriteHintVisible(false);
    resetDiscoverRegistrationForm();
  ...
  const submitDiscoverRegistration = async () => {
    ...
    if (!discoverRegistrationType) {
      Alert.alert('Choose a listing type', 'Select Business or Shelter / Rescue to continue.');
      return;
    }
    ...
    if (discoverRegistrationType === 'business' && !businessPayload.name) {
      Alert.alert('Business name required', 'Please enter a business name.');
      return;
    }
    if (discoverRegistrationType === 'shelter' && !shelterPayload.name) {
    ...
    try {
      ...
      const tableName = discoverRegistrationType === 'business' ? 'businesses' : 'shelters';
      const payload = discoverRegistrationType === 'business' ? businessPayload : shelterPayload;
      const { error } = await supabase
        .from(tableName)
        .insert([payload]);
      ...
      Alert.alert('Listing submitted', 'Your listing was submitted for review.');
            ...
            <View style={s.discoverPage}>
              ...
              >
                <View style={s.discoverListingEntryIconWrap}>
                  <MaterialCommunityIcons name="storefront-outline" size={22} color={C.primaryActionBg} />
                </View>
                <View style={s.flex}>
                  <Text style={s.discoverListingEntryTitle}>List your business or shelter</Text>
                  <Text style={s.discoverListingEntrySubtitle}>
                    Submit a local listing for review and approval.
                  </Text>
                </View>
                          ...
                          <>
                            {!authUser?.id ? (
                              <DiscoverDetailSection title="Sign in required">
                                <Text style={s.discoverDetailBodyText}>Sign in to submit a listing.</Text>
                              </DiscoverDetailSection>
                            ) : (
                              <>
                                <View style={s.discoverDetailHero}>
                                  <View style={s.discoverDetailHeroBody}>
                                    <View style={s.discoverDetailHeroTitleRow}>
                                      <View style={s.flex}>
                                        <Text style={s.discoverDetailTitle}>List your business or shelter</Text>
                                        <Text style={s.discoverDetailSubtitle}>Submit a listing for approval by the PetSync+ team.</Text>
                                      </View>
                                      <View style={s.discoverSectionPill}>
                                        <Text style={s.discoverSectionPillText}>New</Text>
                                      </View>
                                    </View>
                                    <Text style={s.discoverDetailBodyText}>
                                      Choose a listing type, then fill in the details you want shared in Discover.
                                    </Text>
                                  </View>
                                </View>
                                    ...
                                    {[
                                      {
                                        type: 'business',
                                        title: 'Business',
                                        body: 'Restaurants, groomers, shops, vets, and other pet-friendly businesses.',
                                      },
                                      {
                                        type: 'shelter',
                                        title: 'Shelter / Rescue',
                                        body: 'Shelters, rescue groups, and adoption partners.',
                                      },
                                    ].map((choice) => {
                                ...
                                {discoverRegistrationType === 'business' ? (
                                  <>
                                ...
                                ) : discoverRegistrationType === 'shelter' ? (
                                  ...
                                  <DiscoverDetailSection title="Next step">
                                    <Text style={s.discoverDetailEmptyText}>Choose Business or Shelter / Rescue to start the form.</Text>
                                  </DiscoverDetailSection>
                                )}

                                {discoverRegistrationType ? (
                                  <TouchableOpacity
                                    style={[
                                  ...
                                  >
                                    {discoverRegistrationSubmitting ? (
                                      ...
                                      <Text style={s.discoverRegistrationSubmitBtnText}>Submit listing for review</Text>
                                    )}
                                  </TouchableOpacity>
                                ) : null}
                              </>
