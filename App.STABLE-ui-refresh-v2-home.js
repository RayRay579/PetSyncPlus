  ...
  return (
    ...
    <SafeAreaView style={[s.screen, { backgroundColor: 'transparent' }]} edges={['top']}>
      <ScrollView scrollEnabled={true} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 90 }}>
        ...
        <Card style={[s.healthScoreCard, { backgroundColor: '#fff', borderColor: '#E6EAF5' }]}>
        ...
        <Card style={[s.dashboardTrendCard, { backgroundColor: '#fff', borderColor: '#E6EAF5' }]}>
        ...
        <Card style={[s.dashboardAICard, { backgroundColor: '#fff', borderColor: '#E6EAF5' }]}>
          <View style={{ flex: 1 }}>
        ...
        <View style={[s.section, { marginTop: 8 }]}>
          ...
          {calendarReminders.length === 0 ? (
            <Card style={[{ backgroundColor: '#fff', borderColor: '#E6EAF5' }]}>
            ...
            calendarReminders.map(reminder => (
              ...
              >
                <Card style={[s.reminderCard, { backgroundColor: '#fff', borderColor: '#E6EAF5' }, reminder.completed && s.reminderCardDone]}>
        ...
        <View style={[s.section, { marginTop: 8 }]}>
          ...
          {recentActivity.length === 0 ? (
            <Card style={[s.recentActivityEmptyCard, { backgroundColor: '#fff', borderColor: '#E6EAF5' }]}>
            ...
            recentActivity.map(log => (
              ...
              >
                <Card style={[s.recentActivityCard, { backgroundColor: '#fff', borderColor: '#E6EAF5' }]}>
