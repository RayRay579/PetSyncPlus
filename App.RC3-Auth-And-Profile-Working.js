...
const profileAvatarUrlColumnMissing = (error) => {
  const message = [
    error?.message,
    error?.details,
    error?.hint,
...
const canWriteProfileAvatarUrl = async () => {
  ...
  try {
    ...
    if (error) {
      if (profileAvatarUrlColumnMissing(error)) {
        console.log('Profile avatar skipped: avatar_url column missing');
      } else {
        console.log('Profile avatar support check error:', error);
      }
  ...
  return (
    ...
    <SafeAreaView style={s.screen} edges={['top']}>
      <View style={s.pageHeader}>
        ...
        <TouchableOpacity style={s.iconBtn} onPress={openMemoryCamera}>
...
function SettingsScreen({ navigation }) {
  ...
  console.log('Settings avatar URL:', profileAvatarUrl);
  console.log('Settings avatar URL:', profileAvatarUrl);
  ...
  const handleSaveProfile = async () => {
    ...
    if (selectedAvatarUri) {
      ...
      if (canSaveAvatar && authUser?.id) {
        ...
        console.log('Uploaded profile avatar URL:', uploadedAvatarUrl);
      }
    }
    ...
    console.log('Saving profile avatar_url:', nextProfile.avatar_url);
...
export default function App() {
  ...
  }, [authReady, setPets, setPetScores]);
