            ...
            >
              ...
              {postMediaUri ? (
                <View style={s.communityPostMediaPreview}>
                  {postMediaType === 'video' ? (
                    <View style={s.communityPostMediaVideoPreview}>
                    ...
                    <Image source={{ uri: postMediaUri }} style={s.communityPostMediaImagePreview} />
                  )}
...
function SettingsScreen({ navigation, route }) {
  ...
  const handlePurchaseSubscriptionPackage = useCallback(async (aPackage, label) => {
    if (!aPackage || subscriptionPurchaseLoading) {
      return;
    }
                    ...
                    <>
                      <TouchableOpacity
                        style={[
                          ...
                          (!monthlyPackage || subscriptionPurchaseLoading) && s.featureLockedPrimaryBtnDisabled,
                        ]}
                        disabled={!monthlyPackage || Boolean(subscriptionPurchaseLoading)}
                      ...
                      <TouchableOpacity
                        style={[
                          s.customActionCancelBtn,
                          s.featureLockedPrimaryBtn,
                          (!yearlyPackage || subscriptionPurchaseLoading) && s.featureLockedPrimaryBtnDisabled,
                        ]}
                        disabled={!yearlyPackage || Boolean(subscriptionPurchaseLoading)}
